...
const zhTranslations: TranslationDictionary = {
  ...
  // Course Acceptance Matrix View
  accTitle: "课程测试验收矩阵",
  accSubtitle: "诚实计算 A/B/C 三组课程验收状态 · 只读聚合清单、产物与 Provider 事实 · 不捏造 PASS · 不带密钥与绝对路径",
  accOverallStatus: "总体验收进度",
  accPassedGroups: "已通过组数",
  accCodeVersion: "代码版本",
  accBenchmarkVersion: "基准版本",
  accGeneratedAt: "生成时间",
  accGroupsTitle: "A / B / C 三组验收卡片",
  accRunGroup: "运行本组验收步骤",
  accRunning: "运行中...",
  accBack: "返回总览",
  accProvidersTitle: "LLM Provider 配置状态",
  accTargetsTitle: "受控闭源样本准入状态",
  accConditionsTitle: "验收条件逐项判定",
  accNoticesTitle: "诚实边界与安全说明",
  accConfigured: "已配置",
  accNotConfigured: "未配置",
  accDefaultPlanner: "默认 Planner 模型",
  accTwoTargets: "样本数",
  accReportLinks: "实验报告产物",
  accNoTargets: "暂无可展示的样本清单",
  accStatus_not_run: "未运行",
  accStatus_running: "运行中",
  accStatus_pass: "通过 (PASS)",
  accStatus_partial: "部分通过 (PARTIAL)",
  accStatus_fail: "未通过 (FAIL)",
  accStatus_blocked: "受阻 (BLOCKED)",
  accRunSuccess: "验收步骤已执行，状态与产物已刷新。",
  accRunFailed: "验收步骤执行失败或未配置真实 Provider。",
  accRunAll: "一键运行全部",
  accSelectProvidersHint: "勾选至少两个真实 Provider 参与本组运行；未配置的 Provider 不可选。",
  accSelectedCount: "已选 Provider 数",
  accComparisonTitle: "双模型对比结果（来自 llm-comparison 规范产物）",
  accColMethod: "方法",
  accColSamples: "样本",
  accColTokens: "Token",
  accColCost: "估算费用",
  accColEvidence: "Evidence",
  accComparisonNote: "LLM-only 的 Evidence Coverage 为 0；分类点估计相同不代表具备 Evidence/Verification 闭环。不同币种不跨币种相加。",
...
const enTranslations: TranslationDictionary = {
  ...
  navPoc: "Controlled PoC",
  navReport: "Audit Report",
  navTrace: "Event Telemetry",
  navApi: "API Console",
  navTestLab: "Security Test Lab",
  navAcceptance: "Acceptance Matrix",
  ...
  // Course Acceptance Matrix View
  accTitle: "Course Test Acceptance Matrix",
  accSubtitle: "Honest A/B/C course acceptance status · Read-only aggregation of manifests, artifacts and provider facts · No fabricated PASS · No keys or absolute paths",
  accOverallStatus: "Overall Acceptance Progress",
  accPassedGroups: "Passed Groups",
  accCodeVersion: "Code Version",
  accBenchmarkVersion: "Benchmark Version",
  accGeneratedAt: "Generated At",
  accGroupsTitle: "A / B / C Acceptance Cards",
  accRunGroup: "Run Acceptance Step",
  accRunning: "Running...",
  accBack: "Back to Overview",
  accProvidersTitle: "LLM Provider Status",
  accTargetsTitle: "Closed-Source Sample Intake",
  accConditionsTitle: "Acceptance Conditions",
  accNoticesTitle: "Honest Boundaries & Safety Notes",
  accConfigured: "Configured",
  accNotConfigured: "Not Configured",
  accDefaultPlanner: "Default Planner Model",
  accTwoTargets: "Samples",
  accReportLinks: "Experiment Reports",
  accNoTargets: "No samples to display",
  accStatus_not_run: "Not Run",
  accStatus_running: "Running",
  accStatus_pass: "PASS",
  accStatus_partial: "PARTIAL",
  accStatus_fail: "FAIL",
  accStatus_blocked: "BLOCKED",
  accRunSuccess: "Acceptance step executed; status and artifacts refreshed.",
  accRunFailed: "Acceptance step failed or no real provider configured.",
  accRunAll: "Run All Groups",
  accSelectProvidersHint: "Select at least two real providers to run this group; unconfigured providers cannot be selected.",
  accSelectedCount: "Selected Providers",
  accComparisonTitle: "Dual-Model Comparison (from llm-comparison artifacts)",
  accColMethod: "Method",
  accColSamples: "Samples",
  accColTokens: "Tokens",
  accColCost: "Est. Cost",
  accColEvidence: "Evidence",
  accComparisonNote: "LLM-only Evidence Coverage is 0; identical classification point estimates do not imply an Evidence/Verification loop. Currencies are never summed across providers.",
